...
ENEMY_SPAWN_DATA = [
    {
        "name": "Mercenary Droid",
        "spawn": (7, 6),
        "waypoints": [(5, 6), (9, 6), (9, 10), (5, 10)],
        "patrol_type": "circular",
        "speed": 1,
        "description": "A rogue military mercenary robot left behind after the war",
        "health": 200, "exp": 300, "attack_damage": 45,
    ...
    },
    {
        ...
        "speed": 1.3,
        "description": "Fast hovering drone guarding abandoned stations",
        "health": 120, "exp": 250, "attack_damage": 30,
        "notice_radius": 170, "attack_radius": 60,
    },
    {
        "name": "X-22 Hunter",
        "sprite_name": "x_22",
        ...
        "patrol_type": "random",
        "speed": 1.2,
        "description": "Experimental AI hunter unit designed to eliminate salvagers",
        "health": 750, "exp": 1000, "attack_damage": 75,
        "notice_radius": 220, "attack_radius": 80,
    },
]
