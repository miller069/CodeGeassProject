...
def create_example_items():
    ...
    items.append(
        Consumable(
            name="Rosin Bag",
            description="Improves grip and control. Boosts pitching stats temporarily.",
            image_path="../graphics/items/rosin_bag.png",
            effect_type="boost",  
            effect_amount=5,
            value=30,
            max_stack=99
    ...
    items.append(
        Consumable(
            name="Energy Drink",
            description="Restores pitcher stamina during long outings.",
